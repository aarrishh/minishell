...
/*   Updated: 2025/09/18 18:32:21 by mabaghda         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				handle_dollar(t_new_line *line_st, t_quote_state state,
						t_env **env);
...
void				handle_len_dollar(t_new_line *line_st, t_quote_state state,
						t_env **env);
